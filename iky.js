...
let ikyads = await getBuffer (`https://telegra.ph/file/1007ba4dd288b19f4b061.jpg`)
...
╰────
╭─[ *MINAT CHAT* ]
│❏  🪀 wa.me/6285697636433?text=sewa+bot
╰────
...
case 'chiisaihentai':
              ...
              contentText:`Follow @alifa.nawang`,buttons,headerType:4}
...
anu = await fetchJson(`https://leyscoders-api.herokuapp.com/api/ppcouple?apikey=IkyOgiwara`)
						...
						buttons = [{buttonId: `!infoig`,buttonText:{displayText: `Follow @alifa.nawang`},type:1}]
...
//------------------< Menunya Bang:v >-------------------
      case 'don':
             reply(`BCA : 5420948664
Dana - Ovo - Gopay : 085697636433
Semua atas nama *M ILHAM*`)
             break
      case 'infoig':
             reply(`http://bit.ly/NylBot`)
             break
      case 'gc':
      reply(`http://bit.ly/NylBot`)
      break
